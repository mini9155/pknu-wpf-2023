...
namespace wp10_employeesApp.ViewModels
{
    public class MainViewModel : Screen
    {
        ...
        {
            using (SqlConnection conn = new SqlConnection("Data Source=localhost;Initial Catalog=pknu;Integrated Security=True"))
            {
                conn.Open();
